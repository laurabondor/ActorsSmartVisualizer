...
<div class="search-container">
  ...
  <br>
  <input type="text" id="lastNameInput" class="search-input" placeholder="Nume de familie">
  <br>
...
<script>
  ...
  function loadContent() {
    var trendingActorNames = ["Scarlett Johansson", "Leonardo DiCaprio", "Brad Pitt", "Jennifer Aniston"];
    var updatesTitles = ["CYNTHIA ERIVO", "ANDREW SCOTT", "MICHAEL B. JORDAN", "LAURA HARRIER"];
    var apiKey = "4557335ecb3e4a8ca099d2d693e25aab";
